...
function disTime(timedifference, language, detailed) {
  ...
  words = {'en' : ['', ' ago', ' and ', ' second ',  ' seconds ',  ' minute ', ' minutes ', ' hour ',   ' hours ',   ' day ',    ' days ',   ' week ',      ' weeks ',     ' month ', ' months ', ' year ', ' years '],
  ...
  for(i = 0; i < elementcount; ++i) {
    ...
    if((typeof(distime)==='number')&&(parseInt(distime, 10)===distime)) {
      ...
      if(distime > 31536000) {
        ...
        if(parseInt(distime/31536000*1.2, 10) === 1) {insert += words[language][15];}
        else                                         {insert += words[language][16];}
      }
      ...
      if(((distime < 60*60*24*365)&&(distime > 60*60*24*7*4))||((distime > 60*60*24*365)&&(detailed) && (parseInt(distime%31536000/2419200, 10) !== 0))) {
        ...
        if(parseInt(distime%31536000/2419200, 10) === 1) {insert += words[language][13];}
        else                                             {insert += words[language][14];}

        if(((distime < 60*60*24*365)&&(detailed)&&(parseInt(distime%2419200/86400, 10) !== 0))) {
          //days
          insert += parseInt(distime%2419200/86400, 10);
          if(parseInt(distime%2419200/86400, 10) === 1) {insert += words[language][9];}
          else                                          {insert += words[language][10];}
        }
      }
      ...
      if(((distime < 60*60*24*7*4)&&(distime > 60*60*24*7))||((distime < 10368000)&&(distime > 2419199)&&(detailed) && (parseInt(distime%2592000/2419200, 10) !== 0))) {
        ...
        if(parseInt(distime%2419200/604800, 10) === 1) {insert += words[language][11];}
        else                                           {insert += words[language][12];}
      }
      ...
      if(((distime < 60*60*24*7)&&(distime > 86399))||((distime < 2419200)&&(distime > 604799)&&(detailed)&&(parseInt(distime%604800/86400, 10) !== 0))) {
        ...
        if(parseInt(distime%604800/86400, 10) === 1) {insert += words[language][9];}
        else                                         {insert += words[language][10];}
      }
      ...
      if(((distime < 86400)&&(distime > 3599))||((distime < 604800)&&(distime > 86399)&&(detailed)&&(parseInt(distime%86400/3600, 10) !== 0))) {
        ...
        if(parseInt(distime%86400/3600, 10) === 1) {insert += words[language][7];}
        else                                       {insert += words[language][8];}
      }
      ...
      if(((distime < 3600)&&(distime > 59))||((distime < 86400)&&(distime > 3599)&&(detailed)&&(parseInt(distime%3600/60, 10) !== 0))) {
        ...
        if(parseInt(distime%3600/60, 10) === 1) {insert += words[language][5];}
        else                                    {insert += words[language][6];}
      }

      if((distime < 60)||((distime < 3600)&&(distime > 59)&&(detailed)&&(distime%60 !== 0))) {
        //seconds
        insert += distime%60;
        if(distime%60 === 1) {insert += words[language][3];}
        else                 {insert += words[language][4];}
      }
